...
# 读取API.env
env_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "API.env")
env_vars = load_env(env_path)

# 高德地图API Key（从API.env读取）
API_KEY = env_vars.get('AMAP_API_KEY')
if not API_KEY:
